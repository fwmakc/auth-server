...
export class LeaderStrategy extends PassportStrategy(Strategy, 'leader') {
  constructor(private readonly configService: ConfigService) {
    super({
      ...
      // http://localhost:3000/account/leader/login
      // http://localhost:3000/account/leader/redirect?code=3c99e78a-4790-4e14-b3f9-fe53bf2276a5
      authorizationURL: `https://leader-id.ru/apps/authorize?client_id=${configService.get(
        'LEADER_CLIENT_ID',
